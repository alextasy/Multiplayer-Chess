        ...
        <div className='HomePage'>
            <div className='hero-section'>
                ...
                <p>Invite your friends and play some chess online! Feel free to
                    <b onClick={()=> history.push('/signup')}> SIGN UP</b> to get cool new features such as having a custom display name, tracking your match history and personal statistics! </p>
